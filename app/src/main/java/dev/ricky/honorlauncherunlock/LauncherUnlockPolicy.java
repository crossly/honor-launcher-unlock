...
public final class LauncherUnlockPolicy {
    ...
    private static final String AOSP_PERMISSION_CONTROLLER_PACKAGE = "com.android.permissioncontroller";
    private static final String GOOGLE_PERMISSION_CONTROLLER_PACKAGE =
    ...
    public static boolean isPermissionControllerTarget(String packageName) {
        return AOSP_PERMISSION_CONTROLLER_PACKAGE.equals(packageName)
                || GOOGLE_PERMISSION_CONTROLLER_PACKAGE.equals(packageName);
    }
